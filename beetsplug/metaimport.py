        ...
        try:
            if source_name == 'deezer':
                ...
                if response:
                    ...
                    self._log.debug('Found {} matching Deezer results', len(filtered_results))
